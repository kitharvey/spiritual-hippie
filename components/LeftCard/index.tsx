  ...
  return (
    <div className="left-card">
      ...
      <div className="buttons-wrapper">
        <button className={isPayment ? "idle" : "active"} onClick={() => setIsPayment(false)}>
          <span>Shipping</span>
        </button>
        <button className={isPayment ? "active" : "idle"} onClick={() => setIsPayment(true)}>
          <span>Payment</span>
        </button>
      </div>
      ...
      <Image src="/assets/Guaranteed_two@2x.png" height={120} width={650} />
